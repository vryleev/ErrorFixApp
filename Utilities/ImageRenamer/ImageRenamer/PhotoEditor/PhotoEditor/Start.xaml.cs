...
namespace PhotoEditor
{
    public partial class Start : Window
    {
        ...
        {
            MainEditorWindow.EnableBlur(this);
        ...
        private void CreateNewFileButtonUp(object sender, RoutedEventArgs e)
        {
            ...
            if (CanvasSizeWindow.ShowDialog() == true)
            {
                ...
                MainEditorWindow.WindowTrigger = 1;
                Close();
        ...
        {
            MainEditorWindow.WindowTrigger = 3;
            Close();
            MainEditorWindow.ShowMainWindow();
        }
        ...
        {
            MainEditorWindow.WindowTrigger = 2;
            Close();
            MainEditorWindow.ShowMainWindow();
        }
        ...
        {
            MainEditorWindow.CloseMainWindow();
            Close();
        }
