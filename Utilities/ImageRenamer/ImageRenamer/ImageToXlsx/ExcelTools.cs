...
namespace ImageToXlsx
{
    public class ExcelTools
    {
        ...
        private static void AddSheetToBook(string sheetName, SpreadsheetDocument spreadsheetDocument, WorksheetPart worksheetPart)
        {
        ...
        public static void InsertText(string docName, string text, string colName, uint rowIndex)
        {
            ...
            using (SpreadsheetDocument spreadSheet = SpreadsheetDocument.Open(docName, true))
            {
                ...
                // Get WorksheetPart
                WorksheetPart worksheetPart = GetWorksheetPartByName(spreadSheet, "26012023");
                ...
                if (worksheetPart == null)
                {
                    ...
                    workBookPart.Workbook.Sheets.AddChild(sheet);
                    worksheetPart = GetWorksheetPartByName(spreadSheet, "26012023");
